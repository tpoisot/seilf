...
<html lang="en">
<head>
    <title>Code coverage report for shelf/lib/entries.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">shelf/lib/</a> entries.js
    </h1>
    <div class='clearfix'>
...
Entry.prototype.id = function() {
  var id = undefined;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.content.id) {
    id = this.content.id;
  }
  return id;
};
...
Entry.prototype.doi = function() {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.content.DOI) {
...
&nbsp;
Entry.prototype.write = <span class="fstat-no" title="function not covered" >function() {</span>
  // TODO: implement
}
&nbsp;
Entry.prototype.read = <span class="fstat-no" title="function not covered" >function() {</span>
  // TODO: implement
}
&nbsp;
